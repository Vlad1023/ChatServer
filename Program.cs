...
namespace ChatServer
{
    class Program
    {
        ...
        static void addUser(ref TcpClient stream,ref List<ClientInfo> clientsList)
        {
            clientsList.Add(new ClientInfo(stream));
        }
        ...
        static void Process(int index,ref List<ClientInfo> clientsList)
        {
